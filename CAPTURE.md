...
one shared clock, one knob), and `AWL_WARP_POSE=straight|left|climb|right|descent|wrap|<seconds>`
(Kite's route; the named poses are each the mid-hold of their leg). None of them

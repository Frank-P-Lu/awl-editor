...
| Export as Word… | Choose a folder, then export the buffer to a `.docx` file; markdown buffers only. | — | — | Native, browser |
| Export as HTML… | Choose a folder, then export the buffer to an `.html` file; markdown buffers only. | — | — | Native, browser |
| Export as PDF… | Choose a folder, then export the buffer to a `.pdf` file; markdown buffers only, native builds only. | — | — | Native |

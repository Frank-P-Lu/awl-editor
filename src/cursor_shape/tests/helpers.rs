...
/// The panel's OTHER bordered buttons (nav prev/next, Replace, Replace all) —
/// same affordance rank as [`ctx_case_toggle`], different flag.
fn ctx_panel_button(over_edge: bool, over_text: bool) -> CursorContext {
    CursorContext {
        dragging_edge: false,
        dragging_text: false,
        overlay_open: false,

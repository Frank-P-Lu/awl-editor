...
use super::model::{
    ...
    PlacardPlacement, RenderCaps, RoleOverrides, RuleSelection, SPELL_UNDERLINE_GAP_DEFAULT,
    SPELL_UNDERLINE_GAP_TIGHT, SelectionStyle, SummonedMaterial, Theme, ThemeTags, TitleStyle,
...
pub const WAGTAIL: Theme = Theme {
    ...
    render_caps: RenderCaps {
        ...
        placard_placement: PlacardPlacement::Contained,
        ...
        summoned_material: SummonedMaterial::Flat,

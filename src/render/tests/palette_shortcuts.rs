...
fn style_name(style: theme::ListStyle) -> &'static str {
    match style {
        ...
        theme::ListStyle::Ruled(theme::RuleSelection::Weight) => "Ruled(Weight)",
        theme::ListStyle::Ruled(theme::RuleSelection::Gutter) => "Ruled(Gutter)",
    }
}
    ...
    for dpi in [1.0_f32, 2.0] {
        ...
        for world in theme::THEMES {
            ...
            match world.render_caps.list_style {
                // `Ruled` is upright too: its rules run ALONG the rows rather

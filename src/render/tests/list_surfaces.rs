...
/// POSTER BARS KEEP THE LIVE PAGE (real pixels): Firetail ships the shared Bars
/// treatment outside Galah's deliberate full-canvas room. Every centered list kind must

...
#[cfg(test)]
use affordance::empty_cell_affordance;
use affordance::place_empty_cell_affordances;
...
fn place_shaped_table<'a>(
    ...
    place_empty_cell_affordances(placed, meta, shaped, xray_lines, context, pan, line_top);

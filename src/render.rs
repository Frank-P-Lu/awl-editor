...
/// Bundled SYMBOL / ORNAMENT face: the roster-driven, OFL Nishiki-teki subset
/// generated by `scripts/regenerate-awl-marks.py`. The 12.3 MB upstream face is
/// never bundled; `assets/fonts/AwlMarks.roster.tsv` owns this derived face's
/// exact cmap and records each mark's role and source range. The generator pins
/// the upstream hash, keeps the private family name and normalises its weight to
/// Regular/400. It is NOT a display face — it is registered under
/// the private family
...
/// glyph chords and markdown ornaments. PUA marks are explicit chrome only,

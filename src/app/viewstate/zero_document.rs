...
impl App {
    ...
    pub(super) fn sync_zero_document_view(&mut self) {
        ...
        view.overlay_query_placeholder = ov.and_then(|o| o.kind.field_placeholder().map(str::to_string));
        ...
        view.overlay_match_highlights = ov.map(|o| o.item_match_highlights()).unwrap_or_default();
